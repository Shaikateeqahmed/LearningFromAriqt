        ...
        <div  class="container-fluid" >
          ...
          <div class="collapse navbar-collapse" id="navbarScroll">
            ...
            <form class="d-flex" role="search" @submit.prevent="SearchFun">
              <input id="search_input" class="form-control me-2" type="search" placeholder="Search" aria-label="Search" v-model="searchItem" @input="debounce">
...
const searchItem = ref(route.query.filter || '');

onMounted(()=>{
  searchItem.value = route.query.filter;
...
const SearchFun = async (event)=>{
     ...
     router.push({
      name : 'home',
      query : {...route.query, filter:searchItem.value}
     })
